          ...
          <Grid.Row>
            ...
            <Grid.Column width={7}>
              ...
              <p style={{ color: "#ffffff88" }}>
                The UMMS Genome Browser is mostly open-source. You can deploy an instance of this application
                on your laptop or server. Contributions to the codebase are welcome. For more information,
                see our <a href="https://www.github.com/hpratt/ummsgb">GitHub</a>.
              </p>
            </Grid.Column>
          </Grid.Row>
        </Grid>
